...
def main():
    ...
    # Extract feature
    with torch.no_grad():
        gallery_feature = extract_feature(model, dataloaders['gallery'], ms)
    ...
    demo.main(result,image_datasets)
    scipy.io.savemat('C:/Users/kdan/BigJob12/main_project/_src/data_analysis/re_id/code/pytorch_result.mat', result)
    print(name)
