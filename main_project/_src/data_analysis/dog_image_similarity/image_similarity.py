...
def show_similar_images(source_dir, output_dir, image_path, location, image_size=224, rand_seed=128):
    ...
    # 유사한 image 보여주기
    compare_similarities_and_show_results(predict, image_path, location, sim_func=euc_sim)


if __name__ == '__main__':
    source_dir = '../../web/static/images/input_image'
    output_dir = '../../../_db/data/model_data/working'
    image_path = '../../../_db/data/Preprocessed_data/[개]'
